...
**Estado (act. 31/07/2026):** DHL **PÚBLICO ACTIVO** (validado por Francisco) · zonas remotas oficiales **CARGADAS** (841 CPs AR, vigencia 04/01/2026) · divisor volumétrico **5.000** (corregido — igual al aéreo).
...
Peso vol. DHL  = volumen ÷ 5.000        (igual al aéreo — corregido 31/07/2026; configurable)
...
- Límites 10 / 29,999 / 30 kg ✓ · volumétrico ÷5.000 puede mandar ✓
...
## 6. Zonas remotas — ✅ RESUELTO (31/07: lista oficial importada con scripts/import-dhl-remote-pdf.mjs)
...
✅ ACTIVADO el 30/07/2026. (Referencia histórica del mecanismo:) El toggle "Mostrar DHL en calculadora pública" del admin activa DHL **solo en ese navegador** (la config vive en localStorage por dispositivo) — sirve para previsualizar la experiencia del cliente.
